...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Professionals\Creator\validator.php]
...
//[Request]-----------------------------------------------------------------------------
//$f->set_ValidationRule("professional","trim|required");
//$f->set_ValidationRule("username","trim|required");
//$f->set_ValidationRule("specialty","trim|required");
