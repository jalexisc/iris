...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-04-10 06:51:48
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Professionals\Creator\form.php]
...
**/
$r["professional"] = $f->get_Value("professional");
$r["username"] = $f->get_Value("username");
$r["specialty"] = $f->get_Value("specialty");
...
$f->fields["username"] = $f->get_FieldText("username", array("value" => $r["username"],"proportion"=>"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["specialty"] = $f->get_FieldText("specialty", array("value" => $r["specialty"],"proportion"=>"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$card = $b->get_Card("create", array(
		 "title" => lang("Iris_Professionals.create-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
