...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-04-10 06:51:13
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Episodes\Creator\form.php]
...
**/
$r["episode"] = $f->get_Value("episode",pk());
$r["patient"] = $f->get_Value("patient");
$r["start_date"] = $f->get_Value("start_date",safe_get_date());
$r["end_date"] = $f->get_Value("end_date",safe_get_date());
$r["reason_for_visit"] = $f->get_Value("reason_for_visit");
$r["general_notes"] = $f->get_Value("general_notes");
