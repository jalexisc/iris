...
$fields = array(
    //"episode" => lang("App.episode"),
    //"patient" => lang("App.patient"),
    //"start_date" => lang("App.start_date"),
    //"end_date" => lang("App.end_date"),
    //"reason_for_visit" => lang("App.reason_for_visit"),
    //"general_notes" => lang("App.general_notes"),
...
//[build]--------------------------------------------------------------------------------------------------------------
$conditions = array();
//$mepisodes->clear_AllCache();
$rows = $mepisodes->getCachedSearch($conditions, $limit, $offset, "episode DESC");
$total = $mepisodes->getCountAllResults($conditions);
...
$bgrid->set_Headers(array(
    ...
    //array("content" => lang("App.end_date"), "class" => "text-center	align-middle"),
    //array("content" => lang("App.reason_for_visit"), "class" => "text-center	align-middle"),
    //array("content" => lang("App.general_notes"), "class" => "text-center	align-middle"),
    ...
    if (!empty($row["episode"])) {
        ...
        $bgrid->add_Row(
            array(
                ...
                //array("content" => $row['end_date'], "class" => "text-left align-middle"),
                //array("content" => $row['reason_for_visit'], "class" => "text-left align-middle"),
                //array("content" => $row['general_notes'], "class" => "text-left align-middle"),
