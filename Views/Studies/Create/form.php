...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-04-10 06:52:19
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Studies\Creator\form.php]
...
$r["study"] = $f->get_Value("study",pk());
$r["episode"] = $f->get_Value("episode",$episode);
$r["study_date"] = $f->get_Value("study_date",safe_get_date());
$r["study_type"] = $f->get_Value("study_type");
...
$card = $b->get_Card2("create", array(
		 "header-title" => lang("Iris_Studies.create-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
