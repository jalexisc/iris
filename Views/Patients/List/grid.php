...
$fields = array(
		 ...
		 //"gender" => lang("App.gender"),
		 //"contact_info" => lang("App.contact_info"),
...
$rows = $mpatients->get_CachedSearch($conditions,$limit, $offset,"patient DESC");
$total = $mpatients->get_CountAllResults($conditions);
...
$bgrid->set_Headers(array(
		array("content" => "#", "class" => "text-center	align-middle"),
		 //array("content" => lang("App.patient"), "class" => "text-center	align-middle"),
		 //array("content" => lang("App.first_name"), "class" => "text-center	align-middle"),
		 //array("content" => lang("App.last_name"), "class" => "text-center	align-middle"),
		 //array("content" => lang("App.document_type"), "class" => "text-center	align-middle"),
		 //array("content" => lang("App.document_number"), "class" => "text-center	align-middle"),
		 ...
		 //array("content" => lang("App.contact_info"), "class" => "text-center	align-middle"),
		 //array("content" => lang("App.registration_date"), "class" => "text-center	align-middle"),
				...
				$bgrid->add_Row(
						array(
								array("content" => $count, "class" => "text-center align-middle"),
								 ...
								 //array("content" => $row['last_name'], "class" => "text-left align-middle"),
								 ...
								 //array("content" => $row['contact_info'], "class" => "text-left align-middle"),
								 //array("content" => $row['registration_date'], "class" => "text-left align-middle"),
...
$card = $bootstrap->get_Card("card-grid", array(
		"title" =>lang('Patients.list-title'),
		"header-back" => $back,
		"header-add"=>"/sie/q10files/import/" . lpk(),
		"alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Patients.list-title'), "message" => lang('Patients.list-description')),
		"content" => $bgrid,
));
echo($card);
?>
