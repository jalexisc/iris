...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mprofessional, esta deberá ser igualada a  model('App\Modules\Iris\Models\Iris_Professional');
* @Instruction $mprofessional = model('App\Modules\Iris\Models\Iris_Professional');
...
*/
class Iris_Professional extends CachedModel
	 {
		 protected $table = "iris_professional";
		 protected $primaryKey = "professional";
...
/**
		 ...
		 * @return array|false
		 */
		 public function getProfessional($professional):false|array
		{
				$result = parent::getCached($professional);
				if (is_array($result)) {
						return ($result);
				} else {
						return (false);
