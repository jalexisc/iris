...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mprofessionals, esta deberá ser igualada a  model('App\Modules\Iris\Models\Iris_Professionals');
* @Instruction $mprofessionals = model('App\Modules\Iris\Models\Iris_Professionals');
...
*/
class Iris_Professionals extends CachedModel
	 {
