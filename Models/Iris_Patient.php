...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mpatient, esta deberá ser igualada a  model('App\Modules\Iris\Models\Iris_Patient');
* @Instruction $mpatient = model('App\Modules\Iris\Models\Iris_Patient');
...
*/
class Iris_Patient extends CachedModel
	 {
		 protected $table = "iris_patient";
		 protected $primaryKey = "patients";
